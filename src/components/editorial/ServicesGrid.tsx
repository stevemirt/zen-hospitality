...
/**
 * Dual-tone service icons.
 * - Base shape: navy (#042b59) at 1px stroke
 * - Cyan accents (#58c3e8) at 1.4px for highlights/details
 * - 80×80 viewBox with more compositional detail per icon
 */
const ICONS: Record<number, React.ReactNode> = {
  0: ( // Property Management — house with lit windows
    <svg viewBox="0 0 80 80" fill="none" strokeLinecap="round" strokeLinejoin="round">
      <path d="M14 36L40 16l26 20" stroke="#042b59" strokeWidth="1" />
      <path d="M18 34v32h44V34" stroke="#042b59" strokeWidth="1" />
      <rect x="32" y="46" width="16" height="20" stroke="#042b59" strokeWidth="1" />
  ...
  1: ( // Concierge — bell with sound waves
    <svg viewBox="0 0 80 80" fill="none" strokeLinecap="round" strokeLinejoin="round">
      <path d="M40 20v-6M28 64h24" stroke="#042b59" strokeWidth="1" />
      <path d="M18 64c0-12 10-22 22-22s22 10 22 22" stroke="#042b59" strokeWidth="1" />
      <circle cx="40" cy="66" r="2.5" fill="#58c3e8" />
      <path d="M34 20h12" stroke="#042b59" strokeWidth="1" />
  ...
  2: ( // Housekeeping — folded linens stack
    <svg viewBox="0 0 80 80" fill="none" strokeLinecap="round" strokeLinejoin="round">
      <rect x="14" y="46" width="52" height="20" stroke="#042b59" strokeWidth="1" />
      <rect x="18" y="34" width="44" height="12" stroke="#042b59" strokeWidth="1" />
      <rect x="22" y="22" width="36" height="12" stroke="#042b59" strokeWidth="1" />
  ...
  3: ( // Maintenance — wrench with bolt
    <svg viewBox="0 0 80 80" fill="none" strokeLinecap="round" strokeLinejoin="round">
      <path d="M52 14a10 10 0 0 1-12 12L20 46l10 10 20-20a10 10 0 0 1 12-12z" stroke="#042b59" strokeWidth="1" />
  ...
  4: ( // Emergencies — shield with check
    <svg viewBox="0 0 80 80" fill="none" strokeLinecap="round" strokeLinejoin="round">
      <path d="M40 12l20 5v14c0 12-8 22-20 28-12-6-20-16-20-28V17z" stroke="#042b59" strokeWidth="1" />
      <path d="M30 40l7 7 14-14" stroke="#58c3e8" strokeWidth="1.6" />
    </svg>
  ),
  5: ( // Sales & Marketing — chart growth + arrow + dots
    <svg viewBox="0 0 80 80" fill="none" strokeLinecap="round" strokeLinejoin="round">
      <path d="M14 66h54" stroke="#042b59" strokeWidth="1" />
      <path d="M18 56l12-12 10 7 18-22" stroke="#042b59" strokeWidth="1" />
  ...
  6: ( // Monthly Reports — document with chart inside
    <svg viewBox="0 0 80 80" fill="none" strokeLinecap="round" strokeLinejoin="round">
      <path d="M22 12h26l10 10v46H22z" stroke="#042b59" strokeWidth="1" />
      <path d="M48 12v10h10" stroke="#042b59" strokeWidth="1" />
  ...
  7: ( // Security — lock with keyhole
    <svg viewBox="0 0 80 80" fill="none" strokeLinecap="round" strokeLinejoin="round">
      <rect x="18" y="34" width="44" height="32" stroke="#042b59" strokeWidth="1" />
      <path d="M26 34v-8a14 14 0 0 1 28 0v8" stroke="#042b59" strokeWidth="1" />
  ...
  8: ( // Quality Management — diamond with rays
    <svg viewBox="0 0 80 80" fill="none" strokeLinecap="round" strokeLinejoin="round">
      <path d="M40 20l8 12 12 8-12 8-8 12-8-12-12-8 12-8z" stroke="#042b59" strokeWidth="1" />
  ...
  9: ( // Special Projects — compass
    <svg viewBox="0 0 80 80" fill="none" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="40" cy="40" r="28" stroke="#042b59" strokeWidth="1" />
      <circle cx="40" cy="40" r="22" stroke="#58c3e8" strokeWidth="0.6" opacity="0.5" />
      <path d="M48 28l-6 18-12 6 6-18z" fill="#58c3e8" stroke="#042b59" strokeWidth="1" />
      <circle cx="40" cy="40" r="2" fill="#042b59" />
...
export function ServicesGrid() {
  ...
  return (
    <Section id="services" tone="light">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 border-l border-t border-[#042b59]/10">
        {items.map((label, i) => (
          <Reveal key={label} delayMs={i * 60}>
            <div className="group relative overflow-hidden border-r border-b border-[#042b59]/10 p-8 md:p-10 h-[280px] flex flex-col justify-between transition-colors duration-300 hover:bg-[#eaf1f6]/50">
              {/* Ghost number — large, faint, behind */}
              <span
                aria-hidden
                className="absolute right-3 bottom-1 select-none pointer-events-none h-display text-[7rem] leading-none tabular-nums text-[#58c3e8]/10 group-hover:text-[#58c3e8]/22 transition-colors duration-500"
              >
                {String(i + 1).padStart(2, "0")}
              </span>

              {/* Icon */}
              <div className="relative w-14 h-14 md:w-16 md:h-16 transition-transform duration-500 group-hover:-translate-y-1">
                {ICONS[i]}
              </div>

              {/* Label + descriptor */}
              <div className="relative mt-6">
                <h3 className="h-title text-base md:text-lg text-[#042b59] leading-snug mb-2">
                  {label}
                </h3>
                {descriptors?.[i] && (
                  <p
                    className="body-luxe text-xs md:text-sm text-[#042b59]/55 leading-relaxed overflow-hidden"
                    style={{
                      display: "-webkit-box",
                      WebkitLineClamp: 3,
